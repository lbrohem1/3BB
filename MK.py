...
settings = {
    ...
    "Respontag":"❌นักฆ่าบ้าเชล❌",
    "ResponPM":"❌นักฆ่าบ้าเชล❌",
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    start = time.time()
                    line.sendMessage(to, "『❌นักฆ่าบ้าเชล❌』")
